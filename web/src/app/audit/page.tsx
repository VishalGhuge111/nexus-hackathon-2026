...
import { Activity, Download, Search, Loader2 } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white border border-zinc-200 rounded-xl overflow-hidden shadow-sm">
            <div className="p-4 border-b border-zinc-100 bg-zinc-50 flex items-center justify-between">
              ...
              <span className="text-xs text-zinc-400">{filtered.length} event{filtered.length === 1 ? '' : 's'}</span>
            </div>
            ...
            {!events && !error ? (
              ...
              <div className="p-12 text-center text-sm text-zinc-500">
                {events && events.length === 0 ? 'No audit events yet — trigger a disruption to generate real activity.' : 'No events match this filter.'}
              </div>
            ) : (
              <div className="p-6">
